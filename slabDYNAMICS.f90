...
CONTAINS
  ...
  SUBROUTINE solve_dynamics
    if(.not.real_space) then
       if(.not.kleads) then
          ...
          call allocate_dynamics_kleads
          call initial_condition_kleads
       end if
    else
       call allocate_dynamics_real_space
       call initial_condition_real_space
    end if
    call evolve
  ...
  CONTAINS
    ...
    end subroutine allocate_dynamics_kleads
    ...
    end subroutine allocate_dynamics_real_space
    ...
    !+- PURPOSE: get initial condition for k-independent leads -+!
    subroutine initial_condition
      ...
      integer     :: it_finer
      integer     :: ik_orth
      integer     :: test_lead,test_hyb,test_slab,test_gz
    ...
    !+- PURPOSE: get initial conditions in the case of k-dependent leads -+!
    subroutine initial_condition_kleads
      implicit none
      integer     :: ik,ik_sys
      integer     :: ialpha,jalpha
      real(8)     :: kl_j,kl_i,kp
    ...
    end subroutine initial_condition_kleads



    !+- PURPOSE: get initial conditions in the case of k-dependent leads -+!
    subroutine initial_condition_real_space
      implicit none
      integer     :: ik,ik_sys
      integer     :: ialpha,jalpha
      real(8)     :: kl_j,kl_i,kp
    ...
    end subroutine initial_condition_real_space
    ...
    end subroutine test_obs_kleads
    ...
    !+- PURPOSE COMPUTE TIME DEPENDENT OBSERVABLES -+!
    subroutine test_obs_real_space(it)
      integer            :: it
      integer            :: ilayer
      integer            :: dim,iSlab
      integer            :: ihyb,ik_sys0,ik_sys
    ...
    end subroutine test_obs_real_space
